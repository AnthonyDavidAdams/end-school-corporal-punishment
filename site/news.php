...
// The cache key carries the shape of what is stored, not just the query. Adding a field to an item
// and leaving the key alone means every visitor keeps getting the old shape until the hour expires,
// which is exactly what happened when the publisher domain was added.
$schema = 2;
$file = "$dir/news-v$schema-" . md5($q) . ".json";
